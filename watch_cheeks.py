...
from src.masking import DEFAULT_MASKING_CONFIG, MaskingConfig, load_masking_config
...
MASK_COUNT_BANDS = list(DEFAULT_MASKING_CONFIG.count_bands)
MASK_TOTAL_BANDS = list(DEFAULT_MASKING_CONFIG.total_bands)
MASK_RATIO_BANDS = list(DEFAULT_MASKING_CONFIG.ratio_bands)
MASK_LEVEL2_WORDS = {
