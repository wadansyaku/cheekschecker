...
from src.masking import DEFAULT_MASKING_CONFIG, load_masking_config
...
MASK_COUNT_BANDS: List[Tuple[int, Optional[int], str]] = list(MASKING_CONFIG.count_bands)
MASK_TOTAL_BANDS: List[Tuple[int, Optional[int], str]] = list(
    MASKING_CONFIG.total_bands
)
MASK_RATIO_BANDS: List[Tuple[float, Optional[float], str]] = list(
    MASKING_CONFIG.ratio_bands
)
